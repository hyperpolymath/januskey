...
// Replace januskey, Januskey — See README.adoc for details., just run, Januskey started successfully. with actuals
= januskey — Quick Start for Users
:toc:
:toclevels: 2

== What is januskey?

Januskey — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./januskey-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/januskey/wiki
