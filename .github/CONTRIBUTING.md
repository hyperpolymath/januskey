...
git clone <https://github.com/hyperpolymath/januskey.git> cd januskey
...
toolbox create januskey-dev toolbox enter januskey-dev \# Install
...
januskey/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/januskey/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/januskey/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/januskey/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/januskey/labels/perimeter-3) — Community sandbox scope
