...
(cross-platform-status
  ...
  (gitlab-mirror
    (path "hyperpolymath/januskey")
    (url "https://gitlab.com/hyperpolymath/januskey")
  ...
  (reconciliation-instructions
    ...
    ";; git remote add gitlab https://gitlab.com/hyperpolymath/januskey.git"
    ";; git fetch gitlab"
    ";;"
